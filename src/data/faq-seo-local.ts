...
export const faqSeoLocalItems: FaqItem[] = [
  ...
  {
    question: '¿Qué pasa si ya tengo ficha de Google pero no aparezco en Maps?',
    answer: `<p class="text-base/7 text-petrol-900">
      Tener ficha no significa estar optimizado. Los motivos más habituales por los que no apareces son:
    </p>
